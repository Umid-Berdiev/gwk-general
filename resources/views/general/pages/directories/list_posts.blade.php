        ...
        <table class="table table-striped small ">
          ...
          @foreach($directories as $key => $name)
            <tr>
              ...
              <td>
                @if(\Auth::user()->role->name == 'Administrator' || \Auth::user()->role->name == 'Editor')
                  <button onclick="getChemicalData({{$name->id}})" data-toggle="modal" data-target="#exampleModal1"
                          type="button"
          ...
          <div class="tab-pane fade show active" id="nav-ru" role="tabpanel" aria-labelledby="nav-ru-tab">
            <table class="table table-striped table-bordered">
              ...
              <tr>
                ...
                <td class="form-group">
                  <input type="checkbox" checked name="isFavotire" class="" @php old('post_place_edit')==1
                    ? 'checked=""' : '' @endphp>
                </td>
              </tr>
              </tbody>
          ...
          <div class="tab-pane fade show active" id="nav-ru" role="tabpanel" aria-labelledby="nav-ru-tab">
            <table class="table table-striped table-bordered">
              ...
              <tr>
                <th scope="row">{{ __('messages.Mark') }}</th>
                <td class="form-group">
                  <input type="checkbox" name="isFavotire_edit" value="1" class="" id="isFavotire_edit" @php
