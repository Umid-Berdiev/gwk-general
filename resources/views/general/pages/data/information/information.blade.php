  ...
  <div class="container mb-4">
    <div class="card pb-3 ">
      ...
      <div class="card-body">
        ...
        <form action="{{route('getinfo')}}" method="get">
          ...
          <table class="table table-condensed">
            <thead>
              <tr>
                ...
                @for($day = 1; $day <= $r_days_in_month; $day++) <th style="text-align: center!important;"
                  class="border-0">{{ $day }}</th>
                  @endfor
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <input type="number" step="0.01" class="form-control object-day-value "
                    style="width: 100px !important; font-size: 14px; !important;" data-id="{{ $item->id }}"
                    data-form-data-object-name="date_info" value="{{ $item->value }}">
