...
<main class="py-3" id="main">
  <div class="container-fluid">
    <div class="row justify-content-between">
      <h4 class="w-100 ml-3 font-weight-bold text-primary">rolls</h4>
      <div class="col-auto">
      ...
      <div class="col-auto">
        <ul class="list-inline small">
          <li class="list-inline-item"><a href="#" class="text-primary"><i class="fas fa-trash-alt fa-lg"></i>
              Удалить</a></li>
          <li class="list-inline-item"><a href="{{route('admin.rolls.create')}}" class="btn btn-primary btn-sm"><i
      ...
      <table class="table table-striped small ">
            ...
            <th scope="col">
              <form>
                <div class="form-group">
                  <label for="exampleInput2">name of rolls</label>
        ...
        <tbody class="text-center">
          ...
          <tr>
            ...
            <td>{{ $key+1 }}</td>
            <td class="text-left">{{$roll->name}}</td>
            <td>
              <button type="button" class="btn btn-sm btn-outline-warning waves-effect"><i
                  class="bi bi-eye"></i></button>
              <button onclick="window.location.href='{{route('admin.rolls.edit',$roll->id)}}'" type="button"
              ...
              <button onclick="if (confirm('Are you sure you want to delete this thing into the database?')) {
                                    window.location.href='{{route('admin.rolls.delete',$roll->id)}}'
                                    } else {
