...
<main class="py-3" id="main">
  <div class="container-fluid">
    <div class="row justify-content-between">
      ...
      <div class="col-auto">
        <ul class="list-inline small">
          <li class="list-inline-item"><a href="{{route('admin.divisions.create')}}" class="btn btn-primary btn-sm"><i
      ...
      <table class="table table-striped small ">
        ...
        <tbody class="text-center">
          ...
          <tr>
            ...
            <td>
              <button onclick="window.location.href='{{route('admin.divisions.edit',$division->id)}}'" type="button"
              ...
              <button onclick="if (confirm('Are you sure you want to delete this thing into the database?')) {
                                        window.location.href='{{route('admin.divisions.delete',$division->id)}}'
                                        } else {
